...
budget <- 40
plan <- ng_optimize_mating_plan(scores, n_crosses, parent_K = K,
...
p_lo <- ng_optimize_mating_plan(scores, n_crosses, parent_K = K,
                                max_crosses_per_parent = 6L,
                                cost_col = "cost", lambda_cost = 0, method = "greedy_local")
p_hi <- ng_optimize_mating_plan(scores, n_crosses, parent_K = K,
                                max_crosses_per_parent = 6L,
...
pl0 <- ng_optimize_mating_plan(scores, n_crosses, parent_K = K,
                               max_crosses_per_parent = 6L,
                               logistic_col = "distance", lambda_logistic = 0,
                               method = "greedy_local")
pl1 <- ng_optimize_mating_plan(scores, n_crosses, parent_K = K,
                               max_crosses_per_parent = 6L,
...
plan_t <- withCallingHandlers(
  ng_optimize_mating_plan(scores, n_crosses, parent_K = K, max_crosses_per_parent = 6L,
