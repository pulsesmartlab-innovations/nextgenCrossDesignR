...
fr <- ng_pareto_mate_allocation(scores, n_crosses, parent_kinship = K)$frontier
...
p_lo <- ng_optimize_mating_plan(scores, n_crosses, parent_kinship = K, target_coancestry = lo_t)
p_hi <- ng_optimize_mating_plan(scores, n_crosses, parent_kinship = K, target_coancestry = hi_t)
...
p_inf <- withCallingHandlers(
  ng_optimize_mating_plan(scores, n_crosses, parent_kinship = K, target_coancestry = too_tight),
...
p_plain <- ng_optimize_mating_plan(scores, n_crosses, parent_kinship = K, lambda_group = 1)
...
p_both <- ng_optimize_mating_plan(scores, n_crosses, parent_kinship = K,
