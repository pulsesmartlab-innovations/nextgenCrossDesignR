  ...
  list(
    ...
    num("min_effect_reliability", "Min marker-effect reliability", "scoring", 0.35,
        ...
        note = paste0("RESERVED and currently inert: it gates the calibrated-reliability ",
                      ...
                      "hook for a future PEV-based reliability. ",
                      "It is NOT the same quantity as min_cv_predictive_r2 and the two ",
                      "are not interchangeable: reliability is r^2 against TRUE BREEDING ",
                      "VALUE, while min_cv_predictive_r2 is an out-of-fold R2 against ",
                      "PHENOTYPE. min_cv_predictive_r2 is the live control; do not ",
                      "surface this one as the reliability setting.")),
